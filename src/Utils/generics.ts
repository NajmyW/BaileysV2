...
export const generateMessageIDV2 = (userId?: string): string => {
	...
	return 'TIXO-' + hash.toString('hex').toUpperCase().substring(0, 18)
}

// generate a random ID to attach to a message
export const generateMessageID = () => 'TIXO-' + randomBytes(6).toString('hex').toUpperCase()
...
export const fetchLatestBaileysVersion = async(options: AxiosRequestConfig<{}> = { }) => {
	const URL = 'https://raw.githubusercontent.com/X-Tio/BaileysV2/master/src/Defaults/baileys-version.json'
	try {
